#Sentiment analysis of "The Hobbit"

rm(list = ls())
library(syuzhet)
hobbit_v <- get_text_as_string(path_to_file = "C://Users//chris//Downloads//thehobbit.txt")

#We may get a warning that there's an incomplete final line in the text, but that's OK. It's not an error.
...
#Let's print it out to see this hobbit_sentiment (or click the variable on the RHS)
